      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <nav className="flex mb-4" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <span className="text-gray-500">{{singular_title}} #{{{singular_name}}.id}</span>
              </li>
            </ol>
          </nav>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">{{singular_title}}</h1>
            </div>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6">
            <h3 className="text-lg leading-6 font-medium text-gray-900">{{singular_title}} Information</h3>
            <p className="mt-1 max-w-2xl text-sm text-gray-500">Details and information about this {{singular_title}}.</p>
          </div>
