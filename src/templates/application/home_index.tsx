import { type OrbitaPage, router } from "@foguete/orbita";
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Your Foguete application is ready to go. Start building amazing web
            applications with Lua and Preact.
          </p>
        </div>
